...
func (o *OkExApi) GetFutureEstimatedPrice(currencyPair CurrencyPair) (float64, error) {
    resp, err := o.client.Get(fmt.Sprintf(FUTURE_API_BASE_URL+FUTURE_ESTIMATED_PRICE, CurrencyPairSymbol[currencyPair]))
    if err != nil {
        return 0, err
    }
...
func (o *OkExApi) GetFutureTicker(currencyPair CurrencyPair, contractType string) (*Ticker, error) {
    url := FUTURE_API_BASE_URL + FUTURE_TICKER_URI
    //fmt.Println(fmt.Sprintf(url, CurrencyPairSymbol[currencyPair], contractType));
    resp, err := o.client.Get(fmt.Sprintf(url, CurrencyPairSymbol[currencyPair], contractType))
    if err != nil {
        return nil, err
    }
...
func (o *OkExApi) GetFutureDepth(currencyPair CurrencyPair, contractType string, size int) (*Depth, error) {
    url := FUTURE_API_BASE_URL + FUTURE_DEPTH_URI
    resp, err := o.client.Get(fmt.Sprintf(url, CurrencyPairSymbol[currencyPair], contractType, size))
    if err != nil {
        return nil, err
    }
...
func (o *OkExApi) GetFutureIndex(currencyPair CurrencyPair) (float64, error) {
    return 0, nil
}
...
func (o *OkExApi) PlaceFutureOrder(currencyPair CurrencyPair, contractType, price, amount string, openType, matchPrice, leverRate int) (string, error) {
    postData := url.Values{};
...
func (o *OkExApi) FutureCancelOrder(currencyPair CurrencyPair, contractType, orderId string) (bool, error) {
    postData := url.Values{};
    postData.Set("symbol", CurrencyPairSymbol[currencyPair]);
...
func (o *OkExApi) GetFuturePosition(currencyPair CurrencyPair, contractType string) ([]FuturePosition, error) {
...
func (o *OkExApi) parseOrders(body []byte, currencyPair CurrencyPair) ([]FutureOrder, error) {
    respMap := make(map[string]interface{});
    err := json.Unmarshal(body, &respMap);
    if err != nil {
        return nil, err;
...
func (o *OkExApi) GetFutureOrders(orderIds []string, currencyPair CurrencyPair, contractType string) ([]FutureOrder, error) {
    postData := url.Values{};
    ...
    return o.parseOrders(body, currencyPair);
}

func (o *OkExApi) GetUnfinishFutureOrders(currencyPair CurrencyPair, contractType string) ([]FutureOrder, error) {
    postData := url.Values{};
...
func (o *OkExApi) GetExchangeRate() (float64, error) {
    respMap, err := HttpGet(o.client, FUTURE_API_BASE_URL+_EXCHANGE_RATE_URI);
    if err != nil {
        log.Println(respMap);
        return -1, err
    }
...
func (o *OkExApi) GetContractValue(currencyPair CurrencyPair) (float64, error) {
    switch currencyPair {
    case BTC_USD:
        return 100, nil;
    case LTC_USD:
...
func (o *OkExApi) GetKlineRecords(contract_type string, currency CurrencyPair, period string, size, since int) ([]FutureKline, error) {
    params := url.Values{}
    ...
    resp, err := o.client.Get(FUTURE_API_BASE_URL + _GET_KLINE_URI + "?" + params.Encode())
    if err != nil {
        log.Println(err)
        return nil, err
    }
...
func (o *OkExApi) GetTrades(currencyPair CurrencyPair, since int64) ([]Trade, error) {
    panic("unimplements")
}
