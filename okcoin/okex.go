...
func (o *OkExApi) GetFutureEstimatedPrice(cp CurrencyPairV2) (float64, error) {
...
func (o *OkExApi) GetFutureTicker(cp CurrencyPairV2, contractType string) (*Ticker, error) {
...
func (o *OkExApi) GetFutureDepth(cp CurrencyPairV2, contractType string, size int) (*Depth, error) {
...
func (o *OkExApi) GetFutureIndex(cp CurrencyPairV2) (float64, error) {
    return 0, nil
}
...
func (o *OkExApi) PlaceFutureOrder(cp CurrencyPairV2, contractType, price, amount string, openType, matchPrice, leverRate int) (string, error) {
    postData := url.Values{}
...
func (o *OkExApi) FutureCancelOrder(cp CurrencyPairV2, contractType, orderId string) (bool, error) {
    postData := url.Values{}
    postData.Set("symbol", cp.CustomSymbol("_", true))
...
func (o *OkExApi) GetFuturePosition(cp CurrencyPairV2, contractType string) ([]FuturePosition, error) {
...
func (o *OkExApi) GetFutureOrders(orderIds []string, cp CurrencyPairV2, contractType string) ([]FutureOrder, error) {
    postData := url.Values{}
...
func (o *OkExApi) GetUnfinishedFutureOrders(cp CurrencyPairV2, contractType string) ([]FutureOrder, error) {
    postData := url.Values{}
...
func (o *OkExApi) GetContractValue(cp CurrencyPairV2) (float64, error) {
...
func (o *OkExApi) GetKlineRecords(contract_type string, cp CurrencyPairV2, period string, size, since int) ([]FutureKline, error) {
    params := url.Values{}
...
func (o *OkExApi) GetTrades(cp CurrencyPairV2, since int64) ([]Trade, error) {
    panic("unsupported")
}

func (o *OkExApi) parseOrders(body []byte, cp CurrencyPairV2) ([]FutureOrder, error) {
    respMap := make(map[string]interface{})
    err := json.Unmarshal(body, &respMap)
    if err != nil {
        return nil, err
