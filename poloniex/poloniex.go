...
func (p *PoloApi) GetOneOrder(orderId string, cp CurrencyPairV2) (*OrderV2, error) {
    postData := url.Values{}
...
func (p *PoloApi) GetAccount() (*AccountV2, error) {
    postData := url.Values{}
...
func (p *PoloApi) GetTicker(cp CurrencyPairV2) (*Ticker, error) {
...
func (p *PoloApi) GetKlineRecords(cp CurrencyPairV2, period string, size, since int) ([]Kline, error) {
    return nil, nil
}

func (p *PoloApi) GetOrderHistory(cp CurrencyPairV2, currentPage, pageSize int) ([]OrderV2, error) {
    return []OrderV2{}, nil
}
